...
(function ($) {
    ...
    skel.init({
        ...
        containers: '100%',
        breakpoints: {
            global: {href: window._templateDirectory + 'css/style.css', grid: {gutters: ['2.5em', 0]}},
            xlarge: {media: '(max-width: 1800px)', href: window._templateDirectory + 'css/style-xlarge.css'},
            large: {media: '(max-width: 1280px)', href: window._templateDirectory + 'css/style-large.css', grid: {gutters: ['2em', 0]}},
            medium: {media: '(max-width: 980px)', href: window._templateDirectory + 'css/style-medium.css'},
            small: {media: '(max-width: 736px)', href: window._templateDirectory + 'css/style-small.css', grid: {gutters: ['1.5em', 0]}, viewport: {scalable: false}},
